...
module CountryCodes
  ...
  #Returns a multi-dimensional array containing the countries and their ids
  def getCountryArray
    countryId = 1
    countryList = []
  ...
  #Returns the Foreign Key if Available, else returns nil
  def getCountryFk name, array
